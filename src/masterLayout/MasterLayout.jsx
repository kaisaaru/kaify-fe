    ...
    <section className={mobileMenu ? "overlay active" : "overlay "}>
        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            <li className='dropdown'>
              <Link href='#'>
                <Icon icon='heroicons:wrench-screwdriver' className='menu-icon' />
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    href='/barang'
                    className={pathname === "/barang" ? "active-page" : ""}
                  >
                ...
                <li>
                  <Link
                    href='/jenis-barang'
                    className={pathname === "/jenis-barang" ? "active-page" : ""}
                  >
                ...
                <li>
                  <Link
                    href='/bukubesar'
                    className={pathname === "/bukubesar" ? "active-page" : ""}
                  >
            ...
            <li className='dropdown'>
              <Link href='#'>
                <Icon icon='heroicons:shopping-cart' className='menu-icon' />
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    href='/barang-masuk'
                    className={pathname === "/barang-masuk" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                    Barang Masuk
                  </Link>
                ...
                <li>
                  <Link
                    href='/barang-keluar'
                    className={pathname === "/barang-keluar" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-warning-main w-auto' />{" "}
                    Barang Keluar
                  </Link>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    ...
                    className={pathname === "/laporan-barang-masuk" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                ...
                <li>
                  <Link
                    ...
                    className={pathname === "/laporan-barang-keluar" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-warning-main w-auto' />{" "}
            ...
            <li className='dropdown'>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    href='/user'
                    className={pathname === "/user" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-primary-600 w-auto' />{" "}
                    User
                  </Link>
                ...
                <li>
                  <Link
                    href='/role-akses'
                    className={pathname === "/role-akses" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-warning-main w-auto' />{" "}
                    Role Akses
                  </Link>
      ...
      >
        ...
        <footer className='d-footer'>
          <div className='row align-items-center justify-content-between'>
            <div className='col-auto'>
              <p className='mb-0'>© 2025 Kaify. All Rights Reserved.</p>
            </div>
            <div className='col-auto'>
              <p className='mb-0'>
